...
- Border: #E5E7EB (1px)
- Signal Color / Primary Brand: #14A800 — used for selected states, primary buttons, active indicators, and key CTAs

# Font
- Heading: Poppins (weights: 700 Bold, url: https://resource-static.bj.bcebos.com/fonts/Poppins-Bold.woff2)
- Body: Inter (weight: 400 Regular, url: https://resource-static.bj.bcebos.com/fonts/Inter-Regular.woff2)
# Animation
## Elemental animation
